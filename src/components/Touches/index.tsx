...
export function Touches() {
  ...
  const animatedStyle = useAnimatedStyle(() => ({
    ...
    backgroundColor: interpolateColor(
      ...
      [0, 1],
      ['#8527E5', '#BF5A07'],
    ), // interpolateColor - shared value, possibilities of shared value, colors by possibilities
  ...
  const onToucheGesture = Gesture.Tap()
    .numberOfTaps(2)
    .onStart(() => {
  ...
  return (
    <View style={styles.container}>
      <GestureDetector gesture={onToucheGesture}>
